                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 col-lg-3 mb-5 mb-lg-0">
                            ...
                            <p className="mt-3"><a href="shop.html" className="btn">ร้านค้า</a></p>
                        </div>

                        <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                            <a className="product-item bg-secondary" style={{ borderRadius: "20px"}} href="car">
                                <img src="images/F1.jpg" className="img-fluid product-thumbnail" style={{borderRadius: "20px"}} />
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                            <a className="product-item bg-secondary" style={{ borderRadius: "20px"}} href="cart.html">
                                <img src="images/โฟมมือ2.jpg" className="img-fluid product-thumbnail" style={{borderRadius: "20px"}} />
                        ...
                        <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                            <a className="product-item bg-secondary" style={{ borderRadius: "20px"}} href="cart.html">
                                <img src="images/tnnew.jpg" className="img-fluid product-thumbnail" style={{borderRadius: "20px"}} />
