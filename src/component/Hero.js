                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-5">
                            <div className="intro-excerpt">
                                ...
                                <p><a href="" className="btn btn-secondary me-2">สินค้า</a><a href="#" className="btn btn-white-outline">สำรวจ</a></p>
                            </div>
                        </div>
                        <div className="col-lg-7">
                            <div className="hero-img-wrap">
                                <img src="images/แพ1.jpg" className="img-fluid mt-4" style={{ height:"500px", borderRadius: "30px"}}/>
                            </div>
                        </div>
                    </div>
                </div>
